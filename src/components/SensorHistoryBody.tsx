...
const SensorHistoryBody = React.forwardRef(
  ({page, number, data, isLoading, setpage, viewOptions}: any, ref: any) => {
    return (
                  ...
                  ListHeaderComponent={() => {
                    return (
                      <View style={styles.title}>
                        ...
                        {(viewOptions == 'All' || viewOptions == 'Date') && (
                          <Text style={[styles.titleTxt, {flex: 2}]}>
                            DATETIME
                          </Text>
                        )}
                      </View>
