...
const Warning = () => {
    ...
    return (
        <Animated.View style={[styles.warning, warningAnim]}>
            <Text style={{ fontSize: 16, color: 'red', fontWeight: 'bold' }}>High temperature!!!</Text>
        </Animated.View>
    )
}
...
const styles = StyleSheet.create({
    warning: {
        position: 'absolute', top: 0, height: 50, width, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(253, 231, 103,.9)'
    },
})