import { Dimensions, StyleSheet, Text, Image, TouchableOpacity, View, TextInput, ScrollView, Modal, ActivityIndicator, ImageBackground, FlatList } from 'react-native'
...
const Profile = ({ navigation, route }: any) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#08130D' }}>
            <View>
                <Image source={require('../utils/minh.png')} style={{ height: height / 2-30, width, position: 'absolute', resizeMode:'contain' }} />
                {
                    blur > 0 && <BlurView
                        blurType="light"
                        blurAmount={blur}
            ...
            >
                <View style={[styles.bottomSheet, { marginTop: height / 2.2 }, { backgroundColor: 'white' }]}>
                    <View style={styles.headerSheet}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[styles.circle, { height: 90, width: 90, backgroundColor: 'pink' }]}>
                            <AntDesign name='heart' size={45} color={'#2653B0'} />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => {
                    ...
                    <View style={{ paddingTop: 50, paddingHorizontal: 30, justifyContent: 'space-around', flex: 1 }}>
                        <View style={styles.section}>
                            <View>
                                <Text style={styles.name}>Du Hung Minh, 21</Text>
                        ...
                        <View style={styles.section}>
                            <View>
                                ...
                                <Text numberOfLines={4} style={[styles.job, { maxWidth: '100%' }]}>Nothing</Text>
                            </View>
                        </View>
                                    ...
                                    renderItem={({ item }) => {
                                        return (
                                            <View style={[styles.box, { borderColor: '#2653B0' }]}>
                                                <Ionicons name="checkmark-done-outline" size={20} color={'#2653B0'} />
                                                <Text style={[styles.redTxt, { color: '#2653B0' }]}>{item}</Text>
                                            </View>
                                        );
                                    }}
                                />
...
const styles = StyleSheet.create({
    ...
    distance: {
        flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', width: 90, height: 40, backgroundColor: 'red', borderRadius: 10
    },
    section: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', },
    name: {
        color: '#2653B0', fontSize: 30, maxWidth: 250, lineHeight: 30, fontWeight: 'bold', fontStyle: 'italic'
    },
    job: {
        color: '#2653B0', fontSize: 18, maxWidth: 250
    },
    headerSheet: {
    ...
    bottomSheet: {
        backgroundColor: '#2653B0', width, borderTopLeftRadius: 50, height: height * 1.5, borderTopRightRadius: 50
    },
    redTxt: {
        fontSize: 18,
    },
